...
* **index.html:** 
Es un formulario de inicio de sesion.
* **panel-control.html:** 
Es un panel de control, donde puedes añadir,dar de baja, editar un articulo y cerrar session .
* **editar.html:**
En este archivo editamos el articulo seleccionado, podemos cambiar el precio, .
